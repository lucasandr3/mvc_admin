...
<?=$this->insert('../components/filtrosCompleto')?>
                                        ...
                                        <?php foreach($vendas as $venda): ?>
                                            <tr>
                                                ...
                                                <td class="text-center d-flex justify-content-around">
                                                    ...
                                                    <a href="<?=url('excluir/venda/' . $venda['id_venda']);?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Excluir Venda">
