<?php $this->layout('template', ['title' => 'Vendas Boleto', 'menu' => 'boletosAprovados', 'breadcrumb' => $breadcrumb]) ?>
            ...
            <div class="card">
                <div class="card-header justify-content-start">
                    ...
                    <div class="text-left ml-1">
                        <h4 class="mb-0">Lista Boletos Aprovados</h4>
                        <small>Aqui estão todas os boletos aprovados</small>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                        <?php foreach ($boletosAprovados['boletosAprovados'] as $boleto): ?>
                            <tr>
                ...
                <?php $this->insert('../components/paginacao', ['data' => $boletosAprovados['paginacaoAprovado']]) ?>
            </div>
        </div>
    </div>
</section>