...
function criaLinksWebHook($uuid)
{
    $links = [
        ['uuid_user' => $uuid, 'descricao' => 'Link Vendas:', 'endpoint' => url('webhook/vendas/').$uuid],
        ['uuid_user' => $uuid, 'descricao' => 'Link Carrinho Abandonado:', 'endpoint' => url('webhook/carrinho_abandonado/').$uuid],
        ['uuid_user' => $uuid, 'descricao' => 'Troca de Plano:', 'endpoint' => url('webhook/troca_plano/').$uuid],
    ];
